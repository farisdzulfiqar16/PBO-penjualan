...
public class DBKonsumen {
    ...
    public DBKonsumen (String host, String user, String pass,String dbn) {
...
//        Class.forName("com.mysql.jdbc.Driver");
    ...
    public static void main (String args[]) {
        DBKonsumen kon = new DBKonsumen ("pbo"); //Sesuaikan dengan nama database anda
